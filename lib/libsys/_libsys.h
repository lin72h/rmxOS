...
typedef int (__sys___proc_info_t)(int, int, int, uint64_t, void *, int);
typedef int (__sys___iopolicysys_t)(int, struct _iopol_param_t *);
...
typedef int (__sys_twq_kernreturn_t)(int, void *, int, int);
...
typedef int (__sys__kernelrpc_mach_vm_allocate_trap_t)(uint32_t, uint64_t *, uint64_t, int);
typedef int (__sys__kernelrpc_mach_vm_deallocate_trap_t)(uint32_t, uint64_t, uint64_t);
typedef int (__sys__kernelrpc_mach_vm_protect_trap_t)(uint32_t, uint64_t, uint64_t, int, int);
typedef int (__sys__kernelrpc_mach_vm_map_trap_t)(uint32_t, uint64_t *, uint64_t, uint64_t, int, int);
typedef int (__sys__kernelrpc_mach_port_allocate_trap_t)(uint32_t, uint32_t, uint32_t *);
typedef int (__sys__kernelrpc_mach_port_destroy_trap_t)(uint32_t, uint32_t);
typedef int (__sys__kernelrpc_mach_port_deallocate_trap_t)(uint32_t, uint32_t);
typedef int (__sys__kernelrpc_mach_port_mod_refs_trap_t)(uint32_t, uint32_t, uint32_t, int);
typedef int (__sys__kernelrpc_mach_port_move_member_trap_t)(uint32_t, uint32_t, uint32_t);
typedef int (__sys__kernelrpc_mach_port_insert_right_trap_t)(uint32_t, uint32_t, uint32_t, uint32_t);
typedef int (__sys__kernelrpc_mach_port_insert_member_trap_t)(uint32_t, uint32_t, uint32_t);
typedef int (__sys__kernelrpc_mach_port_extract_member_trap_t)(uint32_t, uint32_t, uint32_t);
typedef int (__sys__kernelrpc_mach_port_construct_trap_t)(uint32_t, struct mach_port_options *, uint64_t, uint32_t *);
typedef int (__sys__kernelrpc_mach_port_destruct_trap_t)(uint32_t, uint32_t, int, uint64_t);
typedef int (__sys_mach_reply_port_t)(void);
typedef int (__sys_thread_self_trap_t)(void);
typedef int (__sys_task_self_trap_t)(void);
typedef int (__sys_host_self_trap_t)(void);
typedef int (__sys_mach_msg_trap_t)(void *, int, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t);
typedef int (__sys_mach_msg_overwrite_trap_t)(void *, int, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, void *, uint32_t);
typedef int (__sys_semaphore_signal_trap_t)(uint32_t);
typedef int (__sys_semaphore_signal_all_trap_t)(uint32_t);
typedef int (__sys_semaphore_signal_thread_trap_t)(uint32_t, uint32_t);
typedef int (__sys_semaphore_wait_trap_t)(uint32_t);
typedef int (__sys_semaphore_wait_signal_trap_t)(uint32_t, uint32_t);
typedef int (__sys_semaphore_timedwait_trap_t)(uint32_t, unsigned int, int);
typedef int (__sys_semaphore_timedwait_signal_trap_t)(uint32_t, uint32_t, unsigned int, int);
typedef int (__sys__kernelrpc_mach_port_guard_trap_t)(uint32_t, uint32_t, uint64_t, int);
typedef int (__sys__kernelrpc_mach_port_unguard_trap_t)(uint32_t, uint32_t, uint64_t);
typedef int (__sys_task_name_for_pid_t)(uint32_t, int, uint32_t *);
typedef int (__sys_task_for_pid_t)(uint32_t, int, uint32_t *);
typedef int (__sys_pid_for_task_t)(uint32_t, int *);
typedef int (__sys_macx_swapon_t)(char *, int, int, int);
typedef int (__sys_macx_swapoff_t)(char *, int);
typedef int (__sys_macx_triggers_t)(int, int, int, uint32_t);
typedef int (__sys_macx_backing_store_suspend_t)(int);
typedef int (__sys_macx_backing_store_recovery_t)(int);
typedef int (__sys_swtch_pri_t)(int);
typedef int (__sys_swtch_t)(void);
typedef int (__sys_thread_switch_t)(uint32_t, int, uint32_t);
typedef int (__sys_clock_sleep_trap_t)(uint32_t, int, int, int, void *);
typedef int (__sys_mach_timebase_info_t)(struct mach_timebase_info *);
typedef int (__sys_mach_wait_until_t)(uint64_t);
typedef int (__sys_mk_timer_create_t)(void);
typedef int (__sys_mk_timer_destroy_t)(uint32_t);
typedef int (__sys_mk_timer_arm_t)(uint32_t, int);
typedef int (__sys_mk_timer_cancel_t)(uint32_t, int *);
...
int __sys___proc_info(int callnum, int pid, int flavor, uint64_t arg, void * buffer, int buffersize);
int __sys___iopolicysys(int cmd, struct _iopol_param_t * param);
...
int __sys_twq_kernreturn(int op, void * arg2, int arg3, int arg4);
...
int __sys__kernelrpc_mach_vm_allocate_trap(uint32_t target, uint64_t * address, uint64_t size, int flags);
int __sys__kernelrpc_mach_vm_deallocate_trap(uint32_t target, uint64_t address, uint64_t size);
int __sys__kernelrpc_mach_vm_protect_trap(uint32_t target, uint64_t address, uint64_t size, int set_maximum, int new_protection);
int __sys__kernelrpc_mach_vm_map_trap(uint32_t target, uint64_t * address, uint64_t size, uint64_t mask, int flags, int cur_protection);
int __sys__kernelrpc_mach_port_allocate_trap(uint32_t target, uint32_t right, uint32_t * name);
int __sys__kernelrpc_mach_port_destroy_trap(uint32_t target, uint32_t name);
int __sys__kernelrpc_mach_port_deallocate_trap(uint32_t target, uint32_t name);
int __sys__kernelrpc_mach_port_mod_refs_trap(uint32_t target, uint32_t name, uint32_t right, int delta);
int __sys__kernelrpc_mach_port_move_member_trap(uint32_t target, uint32_t member, uint32_t after);
int __sys__kernelrpc_mach_port_insert_right_trap(uint32_t target, uint32_t name, uint32_t poly, uint32_t polyPoly);
int __sys__kernelrpc_mach_port_insert_member_trap(uint32_t target, uint32_t name, uint32_t pset);
int __sys__kernelrpc_mach_port_extract_member_trap(uint32_t target, uint32_t name, uint32_t pset);
int __sys__kernelrpc_mach_port_construct_trap(uint32_t target, struct mach_port_options * options, uint64_t context, uint32_t * name);
int __sys__kernelrpc_mach_port_destruct_trap(uint32_t target, uint32_t name, int srdelta, uint64_t guard);
int __sys_mach_reply_port(void);
int __sys_thread_self_trap(void);
int __sys_task_self_trap(void);
int __sys_host_self_trap(void);
int __sys_mach_msg_trap(void * msg, int option, uint32_t send_size, uint32_t rcv_size, uint32_t rcv_name, uint32_t timeout, uint32_t notify);
int __sys_mach_msg_overwrite_trap(void * msg, int option, uint32_t send_size, uint32_t rcv_size, uint32_t rcv_name, uint32_t timeout, uint32_t notify, void * rcv_msg, uint32_t scatter_list_size);
int __sys_semaphore_signal_trap(uint32_t signal_name);
int __sys_semaphore_signal_all_trap(uint32_t signal_name);
int __sys_semaphore_signal_thread_trap(uint32_t signal_name, uint32_t thread);
int __sys_semaphore_wait_trap(uint32_t wait_name);
int __sys_semaphore_wait_signal_trap(uint32_t wait_name, uint32_t signal_name);
int __sys_semaphore_timedwait_trap(uint32_t wait_name, unsigned int sec, int nsec);
int __sys_semaphore_timedwait_signal_trap(uint32_t wait_name, uint32_t signal_name, unsigned int sec, int nsec);
int __sys__kernelrpc_mach_port_guard_trap(uint32_t target, uint32_t name, uint64_t guard, int strict);
int __sys__kernelrpc_mach_port_unguard_trap(uint32_t target, uint32_t name, uint64_t guard);
int __sys_task_name_for_pid(uint32_t target_tport, int pid, uint32_t * tn);
int __sys_task_for_pid(uint32_t target_tport, int pid, uint32_t * t);
int __sys_pid_for_task(uint32_t t, int * pid);
int __sys_macx_swapon(char * name, int flags, int size, int priority);
int __sys_macx_swapoff(char * name, int flags);
int __sys_macx_triggers(int hi_water, int low_water, int flags, uint32_t alert_port);
int __sys_macx_backing_store_suspend(int suspend);
int __sys_macx_backing_store_recovery(int pid);
int __sys_swtch_pri(int pri);
int __sys_swtch(void);
int __sys_thread_switch(uint32_t thread_name, int option, uint32_t option_time);
int __sys_clock_sleep_trap(uint32_t clock_name, int sleep_type, int sleep_sec, int sleep_nsec, void * wakeup_time);
int __sys_mach_timebase_info(struct mach_timebase_info * info);
int __sys_mach_wait_until(uint64_t deadline);
int __sys_mk_timer_create(void);
int __sys_mk_timer_destroy(uint32_t name);
int __sys_mk_timer_arm(uint32_t name, int expire_time);
int __sys_mk_timer_cancel(uint32_t name, int * result_time);
__END_DECLS
