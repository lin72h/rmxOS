...
typedef int (__sys_mach_msg_overwrite_trap_t)(void *, int, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, void *);
...
int __sys_mach_msg_overwrite_trap(void * msg, int option, uint32_t send_size, uint32_t rcv_size, uint32_t rcv_name, uint32_t timeout, uint32_t notify, void * overwrite_args);
