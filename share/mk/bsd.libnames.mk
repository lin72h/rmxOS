...
LIBASL?=	${LIBDESTDIR}${LIBDIR_BASE}/libasl.a
...
LIBDISPATCH?=	${LIBDESTDIR}${LIBDIR_BASE}/libdispatch.a
...
LIBLAUNCH?=	${LIBDESTDIR}${LIBDIR_BASE}/liblaunch.a
LIBLN?=		"don't use LIBLN, use LIBL"
LIBLZMA?=	${LIBDESTDIR}${LIBDIR_BASE}/liblzma.a
LIBM?=		${LIBDESTDIR}${LIBDIR_BASE}/libm.a
LIBMACH?=	${LIBDESTDIR}${LIBDIR_BASE}/libmach.a
...
LIBNOTIFY?=	${LIBDESTDIR}${LIBDIR_BASE}/libnotify.a
...
LIBOSXSUPPORT?=	${LIBDESTDIR}${LIBDIR_BASE}/libosxsupport.a
...
LIBXPC?=	${LIBDESTDIR}${LIBDIR_BASE}/libxpc.a
